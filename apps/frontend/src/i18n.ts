...
const enUS: Record<string, string> = {
  ...
  'teacher.submissionDetail.breadcrumb': 'Submission',
  'teacher.submissionDetail.empty': 'Submission details are not wired yet',
  'teacher.submissionDetail.emptyHint': 'Detailed breakdowns will appear here once the API is connected.',
...
const zhCN: Record<string, string> = {
  ...
  'teacher.submissionDetail.breadcrumb': '提交',
  'teacher.submissionDetail.empty': '提交详情尚未接入',
  'teacher.submissionDetail.emptyHint': '接口接入后将显示详细分析。',
